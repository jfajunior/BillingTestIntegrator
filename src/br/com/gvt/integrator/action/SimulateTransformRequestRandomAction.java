 ...
 *         GVT - 2014.09
 */
public class SimulateTransformRequestRandomAction extends AbstractAction {
	private static final long serialVersionUID = 5740404297404280968L;
	private final Logger _logger = Logger.getLogger(SimulateTransformRequestRandomAction.class);
	...
	public SimulateTransformRequestRandomAction(JFrame mainFrame, TabPanelBilling panelTabBilling) {
	...
	private static String generateNewAccountAndProfileId() {
		return "7-" + MathUtils.getIntRandom(9) + "GEN";
	}
	...
	private static String generateNewAccountName(String accountName) {
		...
		return accountName + " - GEN" + MathUtils.getIntRandom(6);
	}
	...
	private static String generateNewDesignator(String designator) {
		...
		return designator + "GEN" + MathUtils.getIntRandom(6);
	}
	...
	private static String generateNewInvoiceProfileCode() {
		return "900" + MathUtils.getIntRandom(9);
	}
